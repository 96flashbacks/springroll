...
static Lights1	light_mario[] = {
	...
	ShapeColor_mario(255, 255, 255), //white
	ShapeColor_mario(114,  28,  14), //shoe brown
	ShapeColor_mario(254, 193, 121), //skin
	ShapeColor_mario( 68,   6,   0), //hair brown
};
...
// 0x04002090
static unsigned short mario_texture_hair_sideburn[] = {
